...
AT_key = os.environ["ANTHROPIC_API_KEY"]
...
# corr_llm = ChatAnthropic(temperature=1, model=corr_llm_id,max_tokens=4096*2)
...
def generate(state:GraphState):
    ...
    # print(raw_code.content)
    with open("history.txt","w") as file:
        file.write(raw_code.content)
