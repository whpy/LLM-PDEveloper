...
code_llm = ChatOpenAI(temperature=1, model=code_llm_id,openai_api_key=DP_key, openai_api_base='https://api.deepseek.com', max_tokens=8192) # o1-preview not supported the max_tokens
...
### corrector llm
corr_llm_id = "deepseek-chat"
print("corr llm: "+corr_llm_id)
corr_llm = ChatOpenAI(temperature=1, model=corr_llm_id, openai_api_key=DP_key, openai_api_base='https://api.deepseek.com', max_tokens=8192) # o1-preview not supported the max_tokens
