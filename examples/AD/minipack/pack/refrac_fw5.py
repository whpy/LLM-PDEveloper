...
code_llm_id = 'gpt-4o'
code_llm = ChatOpenAI(temperature=0.1, model=code_llm_id)
...
### corrector llm
corr_llm_id = "gpt-4o"
corr_llm = ChatOpenAI(temperature=0.05, model=corr_llm_id) # o1-preview not supported the max_tokens
...
'''
### verifier agent
ver_llm_id = 'o1-2024-12-17'
print("verifier_id",ver_llm_id)
ver_llm = ChatOpenAI( model=ver_llm_id)
