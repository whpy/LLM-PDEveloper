...
Your tasks:
1. The suggestion you recieve is in text, your task is to transform it into the correct format. The format is a special class consist of two lists.\n\
2. All the modifications in the given suggestion are incremental, which means the new codes would be directly added at the end of files. Your output should be two lists: one includes the names of the files to be added, and the other one should include the codes to be added.\
For example, if "test0.py" would be added "print("hello world!")" and "src/utils.py" would be added "print("byebye")", your output should be like ["test0.py","src/utils.py"], ["print("hello world!")","print("byebye")"]\n\ 
Here are some notes:\n\
...
Here is the suggestion generated by other LLM:\n\
{generation}""",
        ),
